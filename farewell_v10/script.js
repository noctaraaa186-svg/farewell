...
// ===== AUDIO =====
var bgAudio = new Audio('audio/lagu.mp3');
bgAudio.loop   = true;
bgAudio.volume = 0.55;
...
function startExperience() {
  ...
  bgAudio.play().catch(function() {
    // Browser blokir autoplay — akan coba lagi saat interaksi berikutnya
...
var POLAROID_DATA = [
  { img: 'images/posda1.jpg', caption: '✦ memories', rot: -8,  x: -155, y: -95  },
  { img: 'images/posda2.jpg', caption: 'together',   rot:  6,  x:  135, y: -80  },
  { img: 'images/posda3.jpg', caption: 'POSDA 25',   rot: -5,  x: -140, y:  85  },
  { img: 'images/posda4.jpg', caption: 'always',     rot:  10, x:  145, y:  95  },
  { img: 'images/posda5.jpg', caption: '♡',          rot: -11, x:   -5, y: -115 },
  { img: 'images/posda6.jpg', caption: 'forever',    rot:   4, x:    5, y:   45 }
];
...
function showPolaroidTransition(callback) {
  ...
  POLAROID_DATA.forEach(function(data, i) {
    setTimeout(function() {
      ...
      frame.style.marginLeft = (data.x - 74) + 'px';
      frame.style.marginTop  = (data.y - 68) + 'px';
...
function proceedToGift() {
  ...
  setTimeout(function() {
    ...
    if (giftText) {
      giftText.classList.remove('show');
      giftText.style.opacity = '';   // jangan paksa inline — biarkan CSS class yang handle
      giftText.style.transform = '';
    }
    ...
    setTimeout(function() {
      ...
      setTimeout(function() {
        ...
        // Label muncul bersamaan dengan kotak, sedikit delay agar terasa bertahap
        setTimeout(function() {
